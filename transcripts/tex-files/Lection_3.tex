...
\fbox{\parbox{\linewidth}{\textbf{Question 1.} What is the score S of the feature pair (2, green)?\\
a) 3 points\\
b) 5 points\\
c) 2points\\
d) 1 point\\
...
a) When having four pips on tom (T=4), I get the highest score S when an orange face is pointing at me (i.e. the gambler).\\
b) The combination (1, red) is not possible.\\
...
Similarly we proceed with the other values for the top pips: 2, 3, 4, 5 and 6 and obtain the following table. %3_4
\begin{figure}[H]
	\centering
...
\fbox{\parbox{\linewidth}{\textbf{Question 3.} What is the probability of the feature pair (2, green)?\\
a) 25\%\\
b) 1/24\\
c) 8.3\%\\
d) 12.5\%
...
The term $P(X_i|red)$ is a .......... whereas $P(X|red)$p is .......... since the first argument is .......... in the first place and .......... in the second.\\
...
\fbox{\parbox{\linewidth}{\textbf{Question 5.} What is the value of the normalization Z in this case: $Z=\sum_iP(S_i|C=g)$?\\
a) 0.5\\
b) 1/24\\
c) 25\%\\
d) 12.5\%
...
For \textit{fixed score S}, the events with the same score but different colors are exclusive and therefore the \textbf{simplified sum rule} $P(S_1 or S_2)=P(S_1)+P(S_2)$ applies.%sum rule
...
b) P(3 pips) = P(3 pips, g)+P(3 pips, r)\\
c) P(g) = P(g, $>$3 pips) + P(g, $\leq$2 pips)\\
d) P(5 pips) = P(5 pips$|$g)+P(5 pips$|$r)\\
e) P(g) = P(g, odd number of pips) + P(g, $\geq$ 2 pips)\\
f) P(g) = P(g, 3 pips) + P(g, $\lnot$ 3 pips)
}}\\
...
a) P(6,g) = P(6$|$g)P(6)\\
b) P(4 pips) = P(4 pips $|>$ 3 pips)P($>$ 3 pips)\\
c) P(r, 4 pips) = $\frac{P(r,4 pips)}{P(4 pips)}$\\
d) P(3$|$r)P(r) = P(r$|$3)P(3)\\
e) P(2,g) = P(g$|$2)P(g)
}}\\
