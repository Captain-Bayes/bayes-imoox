...
The ..... distribution gives the probability for having ...... siccesses when performing ........ repeated ....... experiments with a success probability ........ .
}}\\
...
\textit{The sample mean converges to the intrinsic mean when the sample size N approaches infinity.}\end{centering}}}\\
...
\textit{Hint: Recall that the sample mean is a random variable -> Standard error.}
